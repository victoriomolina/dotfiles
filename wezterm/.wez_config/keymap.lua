...
M.smart_split = wezterm.action_callback(function(window, pane)
	...
	local split_action = dim.pixel_height > dim.pixel_width and act.SplitVertical({ domain = "CurrentPaneDomain" })
...
M.keymap = {
	-- Full screen
	{ mods = M.double_mod, key = "f", action = wezterm.action.ToggleFullScreen },
